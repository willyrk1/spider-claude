...
/** Solve a reproducible deal (by suits + seed) and play out the solution. */
  ...
  return (
    <>
      <div className="controls">
        ...
        {resp && (
          <button onClick={() => setSeed((s) => s + 1)} title="Bump the seed for a new deal">
            Next deal →
          </button>
        )}
      </div>
          ...
          {states && (
            <div className="player">
              ...
              <div className="move-desc">
                {currentMove ? describeMove(currentMove) : 'Initial deal'}{' '}
